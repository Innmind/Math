...
class DivisionTest extends TestCase
{
    ...
    {
        $number = (new Division(new Number(8), new Number(2)))->binaryLogarithm();
    ...
    {
        $number = (new Division(new Number(8), new Number(2)))->naturalLogarithm();
    ...
    {
        $number = (new Division(new Number(8), new Number(2)))->commonLogarithm();
    ...
    {
        $number = (new Division(new Number(8), new Number(2)))->signum();
