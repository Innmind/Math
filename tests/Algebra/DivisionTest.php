...
class DivisionTest extends TestCase
{
    ...
    {
        $number = Number::of(8)->divideBy(Number::of(2))->binaryLogarithm();
    ...
    {
        $number = Number::of(8)->divideBy(Number::of(2))->naturalLogarithm();
    ...
    {
        $number = Number::of(8)->divideBy(Number::of(2))->commonLogarithm();
