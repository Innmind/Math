...
class FunctionsTest extends TestCase
{
    ...
    {
        $this->assertEquals(Round::up(Real::of(4.85), 1), roundUp(4.85, 1));
        $this->assertEquals(Round::down(Real::of(4.85), 1), roundDown(4.85, 1));
        $this->assertEquals(Round::even(Real::of(4.85), 1), roundEven(4.85, 1));
        $this->assertEquals(Round::odd(Real::of(4.85), 1), roundOdd(4.85, 1));
    }
    ...
    public function testFrequence()
    {
        ...
        $this->assertSame(
            divide(2, 6)->value(),
            $frequence(Real::of(1))->value(),
        );
        $this->assertSame(
            divide(2, 6)->value(),
            $frequence(Real::of(4))->value(),
        );
        $this->assertSame(
            divide(1, 6)->value(),
            $frequence(Real::of(2))->value(),
        );
        $this->assertSame(
            divide(1, 6)->value(),
            $frequence(Real::of(3))->value(),
        );
    }
    ...
    public function cosines(): array
    {
        return [
            ...
            [divide(squareRoot(3), 2), Real::of(30)],
            [divide(squareRoot(3), 2), Degree::of(Real::of(30))],
            [divide(squareRoot(3), 2), (Degree::of(Real::of(30)))->toRadian()],
        ];
    }
    ...
    public function sines(): array
    {
        return [
            ...
            [divide(squareRoot(3), 2), Real::of(60)],
            [divide(squareRoot(3), 2), Degree::of(Real::of(60))],
            [divide(squareRoot(3), 2), (Degree::of(Real::of(60)))->toRadian()],
            [Real::of(0.5), 30],
            [Real::of(0.5), 30.0],
            [Real::of(0.5), Real::of(30)],
            [Real::of(0.5), Degree::of(Real::of(30))],
            [Real::of(0.5), (Degree::of(Real::of(30)))->toRadian()],
        ];
    }
