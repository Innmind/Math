...
class LinearRegressionTest extends TestCase
{
    ...
    {
        $r = LinearRegression::of(Dataset::of([0.5, 1, 4, -1]));
    ...
    {
        $regression = LinearRegression::of(Dataset::of([0.5, 1, 4, -1]));
